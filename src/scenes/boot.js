...
import Nivel4 from '../../assets/tiled/Nivel4.json';
import Nivel5 from '../../assets/tiled/Nivel5.json';
...
export default class Boot extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('tiles3',Nivel3);
    this.load.image('tiles4',Nivel4);
    this.load.image('tiles5',Nivel5);
