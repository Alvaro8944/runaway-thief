...
createEnemies() {
    ...
    const enemy2Positions = [
      ...
      { x: 1000, y: 500, type: 'normal' },
      { x: 1150, y: 500, type: 'normal' },
      { x: 2080, y: 640, type: 'patrolling' },
      { x: 2980, y: 230, type: 'patrolling' },
      { x: 4480, y: 750, type: 'patrolling' },
      { x: 5700, y: 700, type: 'patrolling' },
      { x: 6400, y: 400, type: 'patrolling' },
      { x: 7000, y: 550, type: 'patrolling' },
      { x: 7160, y: 70, type: 'patrolling' },
      { x: 7360, y: 70, type: 'patrolling' },
      { x: 8000, y: 320, type: 'patrolling' },
      { x: 7900, y: 640, type: 'patrolling' },
     ...
     const enemy3Positions = [
      ...
      { x: 600, y: 640, type: 'patrolling' },
      { x: 400, y: 250, type: 'patrolling' },
      { x: 1000, y: 100, type: 'patrolling' },
      { x: 1200, y: 100, type: 'patrolling' },
      { x: 1600, y: 500, type: 'attacking' },
      { x: 2400, y: 320, type: 'attacking' },
      { x: 2750, y: 500, type: 'attacking' },
      { x: 3070, y: 500, type: 'attacking' },
      { x: 3520, y: 500, type: 'attacking' },
      { x: 3670, y: 500, type: 'attacking' },
      { x: 5000, y: 400, type: 'patrolling' },
      { x: 5000, y: 700, type: 'patrolling' },
      { x: 5600, y: 100, type: 'smart' },
      { x: 5850, y: 100, type: 'smart' },
      { x: 6400, y: 200, type: 'smart' },
      { x: 7360, y: 200, type: 'smart' },
      { x: 7680, y: 640, type: 'smart' },
      { x: 8000, y: 640, type: 'smart' },
      { x: 8320, y: 640, type: 'smart' },
      { x: 8640, y: 640, type: 'smart' },
      { x: 8800, y: 200, type: 'smart' },
      { x: 9400, y: 100, type: 'patrolling' },
...
//Método que calcula daño en función del tiempo transcurrido desde el disparo de la bala
  ...
  setupCollisions() {
    ...
    this.events.on('gameOver', () => {
      console.log('[Level] Evento gameOver recibido. Cambiando a GameOverScene.');
      ...
      // Transición al boot2
      this.time.delayedCall(1000, () => {
        console.log('Cambiando a escena gameover');
        // Limpiar referencias antes de cambiar de escena
        // Desactivar actualizaciones en objetos que podrían causar problemas
        if (this.gameUI) {
          this.gameUI.update = () => {}; // Reemplazar con función vacía para evitar actualizaciones
        ...
        this.scene.start('GameOverScene', { level: 'level3' });
      });
    });
  }
  ...
  checkPlayerFallOffMap() {
    ...
    if (this.player.y > fallThreshold) {
      console.log('[Level] El jugador ha caído fuera del mapa');
